...
export const CollapseButton = (props: CollapseButtonProps) => {
  ...
  return (
    <Button
      ...
      className={cx(
        "w-1/3 transition duration-1000 ease-in-out flex justify-center bottom-0 disabled:opacity-100  items-center absolute left-[50%] right-[50%] -translate-x-1/2 translate-y-3  h-7 rounded-full",
        currenctExchangersIsSuccessState
          ? "bg-mainColor border-2 border-darkGray w-1/4 "
          : "bg-lightGray"
      )}
    >
      <LogoArrow
